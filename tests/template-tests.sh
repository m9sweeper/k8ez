...
helm template test-everything-app ../charts/k8ez --values everything.values.yaml --set-string nameOverride=k8sIngress-nameOverride --set-string fullnameOverride=test-everything-app-k8sIngress -n default > full-features-test.yaml
